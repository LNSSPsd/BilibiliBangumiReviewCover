...
@interface BBPgcPhoneBangumiReviewDetailShortReviewItem : NSObject
@property (nonatomic, strong, readwrite) BBPgcPhoneBangumiReviewDetailUserRate *user_rating;
@end

@interface BBPgcPhoneBangumiShortReviewItemCell : UITableViewCell
@property (nonatomic, strong, readwrite) BBPgcPhoneBangumiReviewDetailShortReviewItem *model;
- (void)updateUIWithModel:(BBPgcPhoneBangumiReviewDetailShortReviewItem *)model;
@end
...
%hook BBPgcPhoneBangumiShortReviewItemCell
